...
import '../future_calls/process_podcast_call.dart' as _i4;
...
class FutureCalls extends _i1.FutureCallDispatch<_FutureCallRef> {
  ...
  void initialize(
    ...
    var registeredFutureCalls = <String, _i1.FutureCall>{
      'ProcessPodcastCallProcessPodcastFutureCall':
          ProcessPodcastCallProcessPodcastFutureCall(),
    };
...
class _FutureCallRef {
  ...
  late final processPodcastCall = _ProcessPodcastCallFutureCallDispatcher(
    _invokeFutureCall,
  );
}

class _ProcessPodcastCallFutureCallDispatcher {
  _ProcessPodcastCallFutureCallDispatcher(this._invokeFutureCall);

  final _InvokeFutureCall _invokeFutureCall;

  Future<void> processPodcast(_i2.ProcessPodcastParams? object) {
...
class ProcessPodcastCallProcessPodcastFutureCall
    extends _i1.FutureCall<_i2.ProcessPodcastParams> {
  @override
  _i3.Future<void> invoke(
    _i1.Session session,
    _i2.ProcessPodcastParams? object,
  ) async {
    await _i4.ProcessPodcastCall().processPodcast(
      session,
      object,
    );
  }
