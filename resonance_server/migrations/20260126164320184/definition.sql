...
--
-- Class GraphEdge as table graph_edge
--
...
--
-- Class GraphNode as table graph_node
--
...
--
-- Class IngestionJob as table ingestion_job
--
CREATE TABLE "ingestion_job" (
    "id" bigserial PRIMARY KEY,
    "podcastId" bigint NOT NULL,
    "userId" text NOT NULL,
    "stage" text NOT NULL DEFAULT 'booting up'::text,
...
--
-- Class Podcast as table podcast
--
CREATE TABLE "podcast" (
    ...
    "thumbnailUrl" text,
    "createdAt" timestamp without time zone NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "graphExists" boolean NOT NULL DEFAULT false
);

--
-- Class SegmentedTranscript as table segmented_transcript
--
...
--
-- Class Speaker as table speaker
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('resonance', '20260126164320184', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260126164320184', "timestamp" = now();
